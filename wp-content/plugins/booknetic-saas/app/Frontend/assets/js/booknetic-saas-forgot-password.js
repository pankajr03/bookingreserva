(function($)
{
	...
	$(document).ready( function()
	{
		...
		$(document).on('click', '.bookneticsaas_forgot_password_btn', function ()
		{
			let form        = $(this).closest('.bookneticsaas_forgot_password'),
				email		= form.find('#bookneticsaas_email').val();

			bookneticSaaS.ajax('forgot_password', { email: email }, function ( result )
			{
			...
			return false;
		}).on('click', '.bookneticsaas_complete_forgot_password_btn', function ()
		{
			let form            = $(this).closest('.bookneticsaas_forgot_password'),
				password1	    = form.find('#bookneticsaas_password1').val(),
				password2		= form.find('#bookneticsaas_password2').val();
			...
			bookneticSaaS.ajax('complete_forgot_password', data, function ( result )
			{
		...
		}).on('click', '.bookneticsaas_resend_activation_link', function ()
		{
			...
			bookneticSaaS.ajax('resend_forgot_password_link', { email: email }, function ( result )
			{
				form.find('.bookneticsaas_resend_activation').hide();
		...
		{
			$(this).find('.bookneticsaas_forgot_password_btn').click();
			return false;
		});
