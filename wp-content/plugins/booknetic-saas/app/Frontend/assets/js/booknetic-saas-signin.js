(function($)
{
	...
	$(document).ready( function()
	{
		...
		}).on('submit', '.bookneticsaas_form', function ()
		{
            ...
            const passwordInput = $(this).closest('.bookneticsaas_login').find('#bookneticsaas_password');
            const eyeOpenIcon = $(this).closest(".bookneticsaas_login").find('.bkntc-eye-open');
            const eyeClosedIcon = $(this).closest(".bookneticsaas_login").find('.bkntc-eye-closed');
