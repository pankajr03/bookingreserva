...
trait MultiTenant
{
    ...
    {
        self::addGlobalScope('tenant', static function (QueryBuilder $builder, $queryType) {
    ...
    public static function scopeNoTenant(QueryBuilder $builder, $noTenant = true): QueryBuilder
    {
        if ($noTenant === false) {
            return $builder;
        }
