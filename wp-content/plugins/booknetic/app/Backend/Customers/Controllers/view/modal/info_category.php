...
<div class="fs-modal-title">
	...
	<div class="title-text"><?php echo bkntc__('Customer Category info')?></div>
	<div class="close-btn" data-dismiss="modal"><i class="fa fa-times"></i></div>
</div>

<div class="fs-modal-body">
	<div class="fs-modal-body-inner">
        <ul class="nav nav-tabs nav-light" data-tab-group="customer_category_info">
            <?php foreach (TabUI::get('customer_category_info')->getSubItems() as $tab): ?>
