                ...
                <select class="form-control" id="input_wp_user">
                    ...
                    foreach ($parameters->getUsers() as $user):?>
                        <option value="<?php echo $user->getId() ?>"
                                <?php echo ($user->getId() == $customer->getUserId() ? 'selected' : '') ?>>
...
<div class="form-row">
    <div class="form-group col-md-6">
        <label for="input_category_id"><?php echo bkntc__('Category') ?></label>
        <select id="input_category_id" class="form-control" placeholder="<?php echo bkntc__('Category') ?>">
            <option  disabled selected>
                <?php echo bkntc__("Select category") ?>
            </option>
            <?php foreach ($categories as $category) : ?>
                <option value="<?php echo $category->id;?>" <?php echo $customer->getCategoryId() == $category->id ? 'selected' : '' ; ?> >
...
<div class="form-row">
    ...
    <div class="form-group col-md-6">
        ...
        <div class="inner-addon left-addon d-flex align-items-center">
            <i><img src="<?php echo Helper::icon('calendar.svg') ?>"  alt=""/></i>
