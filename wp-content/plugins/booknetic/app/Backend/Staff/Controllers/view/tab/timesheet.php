    ...
    <div class="form-group col-md-12">
        <div class="form-control-checkbox">
            ...
            <div class="fs_onoffswitch">
                <input type="checkbox" class="fs_onoffswitch-checkbox" id="set_specific_timesheet_checkbox"<?php echo $parameters->hasSpecificTimesheet() ? ' checked' : ''?>>
...
$tsEditInfo = $parameters->getTimesheet();

foreach ($weekDays as $dayNum => $weekDay) {
    $editInfo = $tsEditInfo[$dayNum] ?? false;
