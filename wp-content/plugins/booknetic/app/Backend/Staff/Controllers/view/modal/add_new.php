...
<div class="fs-modal-title">
	...
	<div class="title-text"><?php echo $parameters->getId() > 0 ? bkntc__('Edit Staff') : bkntc__('Add Staff')?></div>
...
?>
	...
	<button type="button" class="btn btn-lg btn-primary" id="addStaffSave"><?php echo $parameters->getId() ? bkntc__('SAVE STAFF') : bkntc__('ADD STAFF')?></button>
</div>
