(function ($)
{
	...
	$(document).ready(function ()
	{
		...
		$('#payment-gateway-settings').on('click', '.step_element:not(.selected_step)', function ()
		{
		...
		$( '#payment-gateway-settings' ).on( 'change', '.step_switch .fs_onoffswitch-checkbox', function () {
