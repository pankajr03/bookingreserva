...
class Theme
{
    ...
    public static function getThemeCss($appearanceId): string
    {
    ...
    private static function checkThemeCssFileExist($appearanceId): bool
    {
    ...
    private static function cssFilePath($appearanceId): string
    {
    ...
    public static function createThemeCssFile($appearanceId)
    {
        ...
        foreach ($defaultColors as $color_name => $color) {
            if (isset($themeColors[ $color_name ]) && is_string($themeColors[ $color_name ]) && preg_match('/#[a-zA-Z0-9]{1,8}/', $themeColors[ $color_name ])) {
                $defaultColors[ $color_name ] = $themeColors[ $color_name ];
            }
        }
