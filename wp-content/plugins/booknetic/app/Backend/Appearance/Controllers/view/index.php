...
/**
 * @var ListAppearanceResponse $parameters
 */
foreach ($parameters->getAppearances() as $appearance) {
    $cssFile = $appearance->getCssFile();
...
<div class="m_header clearfix">
	<div class="m_head_title float-left"><?php echo bkntc__('Appearance')?> <span class="badge badge-warning row_count"><?php echo $parameters->getCount() ?></span></div>
	...
	<div class="row">
        ...
        foreach ($parameters->getAppearances() as $appearance) {
			...
			<div class="col-sm-6 col-md-4">
				<div class="appearance_box<?php echo $appearance->isDefault() ? ' appearance_box_active' : ''?>" data-id="<?php echo (int)$appearance->getId()?>">
					<a href="?page=<?php echo Helper::getSlugName() ?>&module=appearance&action=edit&id=<?php echo $appearance->getId()?>" class="appearance_box_preview">

						<div class="booknetic_appointment" id="booknetic_theme_<?php echo $appearance->getId()?>">
					...
					<div class="appearance_box_footer">
						<a href="?page=<?php echo Helper::getSlugName() ?>&module=appearance&action=edit&id=<?php echo $appearance->getId()?>" class="appearance_box_name"><?php echo htmlspecialchars($appearance->getName()) ?></a>
						<?php
