			...
			<div class="fs_portlet_content">
				...
				<div class="f_option_element">
					...
					<span class="f_option_val">
						<div class="inner-addon d-flex align-items-center" style="gap: 5px">
							<input value="<?php echo htmlspecialchars($parameters->getName())?>" id="input_name" class="form-control p-0" placeholder="<?php echo bkntc__('Type name...')?>" maxlength="100">
							<i class="far fa-edit position-static p-0"></i>
						</div>
					</span>
				</div>
