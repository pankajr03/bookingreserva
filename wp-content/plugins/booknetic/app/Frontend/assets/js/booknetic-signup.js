(function ($) {
    ...
    $(document).ready( function()
    {
        ...
        }).on('submit', '.booknetic_form', function ()
        {
            ...
            const passwordInput = $(this).closest('.booknetic_signup').find('#booknetic_password');
            const eyeOpenIcon = $(this).closest(".booknetic_signup").find('.bkntc-eye-open');
            const eyeClosedIcon = $(this).closest(".booknetic_signup").find('.bkntc-eye-closed');
